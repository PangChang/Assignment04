...
public class WritingScores : MonoBehaviour
{
    ...
    public void AddNewScore()
    {
        ...
        newName = DataManager.PlayerName;
        newScore = Score.MaxPointCount.ToString();
        ...
        TextAsset asset = (TextAsset)Resources.Load("scores.txt");
